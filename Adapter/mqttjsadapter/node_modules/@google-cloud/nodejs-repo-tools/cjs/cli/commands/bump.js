...
const DESCRIPTION = `Bumps the specified semver value in both the main package and dependent packages (e.g. samples). ${'rev'.yellow.bold} can be one of ${'major'.green.bold}, ${'minor'.green.bold}, or ${'patch'.green.bold}.`;
const USAGE = `Usage:
  ${COMMAND.bold}
Description:
  ${DESCRIPTION}
...
exports.handler = opts => {
  try {
    ...
    let samplesPackageJsonPath = path.join(buildPack.config.global.localPath, 'samples', 'package.json');
